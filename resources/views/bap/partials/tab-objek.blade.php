<div id="objek" class="tab-pane fade">
    ...
    <div class="form-group">
        ...
        <input type="text" name="objek_nama" class="form-control" required
            value="{{ old('objek_nama', $ba->objek_nama ?? '') }}">
    </div>
    <div class="form-group">
        <label>Alamat</label>
        <input type="text" name="objek_alamat" class="form-control" required
            value="{{ old('objek_alamat', $ba->objek_alamat ?? '') }}">
    </div>
    <div class="form-group">
        <label>Kabupaten / Kota</label>
        <input type="text" name="objek_kota" class="form-control" required
            value="{{ old('objek_kota', $ba->objek_kota ?? '') }}">
    </div>
    <div class="form-group">
        <label>Dalam Rangka (Maksud)</label>
        <input type="text" name="dalam_rangka" class="form-control" required
            value="{{ old('dalam_rangka', $ba->dalam_rangka ?? '') }}" placeholder="Pemeriksaan rutin...">
    </div>
