<div class="flex items-center justify-center gap-2">
    <!-- Tombol PDF -->
    <a href="{{ route('berita-acara.pdf', $row->id) }}" target="_blank" class="btn btn-primary btn-sm">
    ...
    @if($user->isAdmin() || $isPetugas)
        <a href="{{ route('berita-acara.edit', $row->id) }}" class="btn btn-warning btn-sm text-white">
