...
<div class="min-h-[75vh] flex flex-col items-center justify-center p-6">
    ...
    <!-- Card Container -->
    <div class="relative w-full max-w-lg bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden transform transition-all duration-500 hover:scale-[1.01]">
        
        <!-- Hiasan Garis Atas (Gradient) -->
        <div class="h-2 w-full bg-gradient-to-r from-red-500 via-orange-400 to-red-500"></div>

        <div class="p-10 text-center">
            
            <!-- Icon Wrapper dengan Animasi Denyut -->
            <div class="relative inline-block mb-8">
                <div class="absolute inset-0 bg-red-100 rounded-full animate-ping opacity-75"></div>
                <div class="relative w-24 h-24 bg-red-50 text-red-500 rounded-full flex items-center justify-center mx-auto shadow-inner border border-red-100">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <a href="{{ url()->previous() }}" 
                   class="group flex items-center justify-center gap-3 px-6 py-3.5 bg-white border-2 border-slate-200 text-slate-600 font-bold rounded-xl hover:border-slate-300 hover:bg-slate-50 hover:text-slate-800 transition-all duration-200 no-underline shadow-sm hover:shadow-md">
                    <span class="glyphicon glyphicon-arrow-left text-sm transition-transform group-hover:-translate-x-1"></span>
                    <span>Kembali</span>
                </a>
