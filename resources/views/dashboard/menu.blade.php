    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <a href="/berita-acara/create"
            ...
            <div class="bg-blue-500 rounded-xl shadow-lg overflow-hidden border-b-8 border-blue-700">
                <div class="p-12 flex items-center justify-between text-white">
                    <span
                        class="glyphicon glyphicon-file text-8xl opacity-80 group-hover:opacity-100 transition-opacity"></span>
        ...
        <a href="{{ route('dashboard', ['tahun' => date('Y')]) }}"
            ...
            <div class="bg-green-500 rounded-xl shadow-lg overflow-hidden border-b-8 border-green-700">
                <div class="p-12 flex items-center justify-between text-white">
                    <span
                        class="glyphicon glyphicon-th-list text-8xl opacity-80 group-hover:opacity-100 transition-opacity"></span>
                    <div class="text-right">
                ...
                <div
                    class="bg-green-600/50 py-3 text-center text-white text-sm font-bold tracking-tighter uppercase italic">
                    Lihat Seluruh Arsip
                </div>
            </div>
        </a>
