...
class BeritaAcaraSeeder extends Seeder
{
    public function run(): void
    {
        $records = [
            ...
            ['id' => 6, 'no_surat_tugas' => 'KP.07.11.6B.05.10.126', 'tgl_surat_tugas' => '2025-10-15', 'tanggal_pemeriksaan' => '2025-10-17', 'hari' => 'Kamis', 'objek_nama' => 'Jembatan', 'objek_alamat' => 'Jalan Kota', 'hasil_pemeriksaan' => 'Boleh', 'created_by' => 8],
            ['id' => 7, 'no_surat_tugas' => 'AD.02.01.2A.05.22.811', 'tgl_surat_tugas' => '2025-04-09', 'tanggal_pemeriksaan' => '2025-05-01', 'hari' => 'Selasa', 'objek_nama' => 'Jembatan', 'objek_alamat' => 'Jalan Kota', 'hasil_pemeriksaan' => 'Iya', 'created_by' => 8],
            ['id' => 8, 'no_surat_tugas' => 'AU.09.01.7C.11.05.116', 'tgl_surat_tugas' => '2024-12-13', 'tanggal_pemeriksaan' => '2025-01-06', 'hari' => 'Rabu', 'objek_nama' => 'Jembatan', 'objek_alamat' => 'Jalan Kota', 'hasil_pemeriksaan' => 'Gk', 'created_by' => 8],
            ['id' => 9, 'no_surat_tugas' => 'AU.09.01.3B.01.15.119', 'tgl_surat_tugas' => '2025-02-06', 'tanggal_pemeriksaan' => '2025-03-05', 'hari' => 'Selasa', 'objek_nama' => 'Jembatan', 'objek_alamat' => 'Jalan Kota', 'hasil_pemeriksaan' => 'Gk', 'created_by' => 8],
            ['id' => 10, 'no_surat_tugas' => 'FA.11.05.9B.01.15.119', 'tgl_surat_tugas' => '2025-05-01', 'tanggal_pemeriksaan' => '2025-06-25', 'hari' => 'Kamis', 'objek_nama' => 'Jembatan', 'objek_alamat' => 'Jalan Kota', 'hasil_pemeriksaan' => 'Gk', 'created_by' => 8],
        ];
